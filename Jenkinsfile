    ...
    stages {
        ...
        stage('Deploy Frontend to Tomcat') {
            steps {
                ...
                xcopy /E /I /Y FRONTEND\\dist\\* "C:\\Program Files\\Apache Software Foundation\\Tomcat 10.1\\webapps\\reactinventory"
                '''
            }
        }
        ...
        stage('Build Backend') {
            steps {
                dir('LISTBACKEND/InventoryManagement') {
        ...
        stage('Deploy Backend to Tomcat') {
            steps {
                ...
                copy "LISTBACKEND\\InventoryManagement\\target\\*.war" "C:\\Program Files\\Apache Software Foundation\\Tomcat 10.1\\webapps\\"
                '''
            }
        }
